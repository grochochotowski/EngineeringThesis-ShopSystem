...
namespace Backend.Api.Api.Services
{
    public class EventsService : IEventsService
    {
        ...
        public async Task<PagedResult<EventDto>> GetAllAsync(string? q, int pageNumber, int pageSize, string? orderBy, string? sortDirection, CancellationToken ct)
        {
            ...
            var pagedResult = await query.Select(e => ToDto(e)).ToPagedResultAsync(pageNumber, pageSize, ct);
            return pagedResult;
        }
