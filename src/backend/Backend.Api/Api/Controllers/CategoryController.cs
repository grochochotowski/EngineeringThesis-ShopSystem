...
namespace Backend.Api.Api.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PagedResult<GetCategoryDto>>> GetAll([FromQuery] PaginationParams pagination, [FromQuery] string? q = null, [FromQuery] bool? isActive = null, [FromQuery] string? orderBy = null, [FromQuery] string? sortDirection = null, CancellationToken ct = default)
        {
            var list = await _service.GetAllAsync(pagination, q, isActive, orderBy, sortDirection, ct);
            return Ok(list);
        }
